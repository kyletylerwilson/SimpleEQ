...
struct FFTDataGenerator
{
    void produceFFTDataForRendering(const juce::AudioBuffer<float>& audioData, const float negativeInfinity)
    {
        ...
        forwardFET->performFrequencyOnlyForwardTransform (fftData.data());
    ...
    void changeOrder(FFTOrder newOrder)
    {
        ...
        forwardFET = std::make_unique<juce::dsp::FFT>(order);
...
private:
    FFTOrder order;
    BlockType fftData;
    std::unique_ptr<juce::dsp::FFT> forwardFET;
...
private:
    ...
    juce::Rectangle<int> getAnalysisArea(); //will be a bit smaller than render area
